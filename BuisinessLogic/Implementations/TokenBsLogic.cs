...
{
  public  class TokenBsLogic : ITokenBsLogic
    {
        ...
        public ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            {
                ValidateAudience = false,  //you might want to validate the audience and issuer depending on your case
                ValidateIssuer = false,
                ValidateIssuerSigningKey = true,
                IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("superSecretKey@345")),
                ValidateLifetime = false //here we are saying that we don't care about the token's expiry date
            };
